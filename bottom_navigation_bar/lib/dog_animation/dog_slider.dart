import 'dart:math';
import 'package:bottom_navigation_bar/dog_animation/dog_flare_controller.dart';

import 'dog_slider_bg_painter.dart';
import 'main.dart';
// import 'moving_character_physics_2d.dart';
import 'package:bottom_navigation_bar/dog_animation/moving_character_physics.dart';
...
// }
  ...
  Widget _buildBallAndArrowStack() {
    return Stack(
      children: <Widget>[
        Image.asset("images/ball.webp", package: App.pkg),
        Transform.translate(
          offset: Offset(26, -2),
  ...
  Widget _buildFlareActor() {
    ...
    var walkingDog = FlareActor(
      // "package:bottom_navigation_bar/dog_animation/DogAnimation.flr",
      "images/DogAnimation.flr",
